...
import rememberMe from "../assets/remember me.png";
...
const SignIn = () => {
      ...
      <main className="main-wrapper h-screen bg-cover">
        <div>
          ...
          <div className="container items-center md:mx-80  pt-6 pb-10 px-8 md:pl-20 md:flex gap-15">
            <form className="bg-white p-6 rounded-xl" onSubmit={handleSubmit(onSubmit)}>
  ...
  <img src="https://www.svgrepo.com/show/475656/google-color.svg" alt="Google Icon" className="w-6 h-6 mr-3" />
  Continue with Google
</button>

                </div >
                <div className="mx-5 md:mx-30">
                <p className="my-5">Dont have an account? <span className="text-[#8D34FF]">Sign up</span></p>
                </div>
                    </div>
            </form>
          </div>
